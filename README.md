...
WynnIris adds native support for all Wynncraft item glint effects, rendered directly in the shader pipeline. Effects work with any Iris-compatible shader pack, no resource pack required.
